...
export type GetResultAggregateType<T extends ResultAggregateArgs> = {
    [P in keyof T & keyof AggregateResult]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateResult[P]> : Prisma.GetScalarType<T[P], AggregateResult[P]>;
};
...
export type GetResultGroupByPayload<T extends ResultGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<ResultGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof ResultGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], ResultGroupByOutputType[P]> : Prisma.GetScalarType<T[P], ResultGroupByOutputType[P]>;
}>>;
export type ResultWhereInput = {
    ...
    subject?: Prisma.StringFilter<"Result"> | string;
    marks?: Prisma.IntFilter<"Result"> | number;
};
...
export type ResultScalarWhereWithAggregatesInput = {
    ...
    subject?: Prisma.StringWithAggregatesFilter<"Result"> | string;
    marks?: Prisma.IntWithAggregatesFilter<"Result"> | number;
};
...
export type ResultOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "studentId" | "subject" | "marks", ExtArgs["result"]["result"]>;
...
export type ResultCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<ResultFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ResultDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['Result'];
        meta: {
            name: 'Result';
        };
    };
     ...
     * })
    **/
    count<T extends ResultCountArgs>(args?: Prisma.Subset<T, ResultCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], ResultCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends ResultGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, ResultGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetResultGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface ResultFieldRefs {
    ...
    readonly subject: Prisma.FieldRef<"Result", 'String'>;
    readonly marks: Prisma.FieldRef<"Result", 'Int'>;
}
/**
 * Result findUnique
 */
